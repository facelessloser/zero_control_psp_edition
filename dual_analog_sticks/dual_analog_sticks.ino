// Original code from tinkerboy https://www.tinkerboy.xyz/arduino-usb-gamepad/
// Code moddified for dual sticks by iamacorn here https://github.com/iamacorn/sudomod
...
void setup() {
  ...
  Joystick.begin();
//   Joystick.setXAxisRange(-512, 400); // Left stick
//   Joystick.setXAxisRange(-512, 512); // Left stick
//   Joystick.setYAxisRange(-512, 512);
   Joystick.setXAxisRange(512, -512); // Left stick
   Joystick.setYAxisRange(512, -512);
//   Joystick.setRxAxisRange(-512, 450); // Right stick
